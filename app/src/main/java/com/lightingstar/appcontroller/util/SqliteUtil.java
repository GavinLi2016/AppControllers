...
public class SqliteUtil extends SQLiteOpenHelper {
    private static Map<String, SqliteUtil> dbMaps = new HashMap<String, SqliteUtil>();
    private OnSqliteUpdateListener onSqliteUpdateListener;
    /**
     * 建表语句列表
     */
    private Map<String,String> createTableList;
    private String nowDbName;

    private SqliteUtil(Context context, String dbName, int dbVersion, Map<String,String> tableSqls) {
        super(context, dbName, null, dbVersion);
        nowDbName = dbName;
        createTableList = new HashMap<>();
        createTableList.putAll(tableSqls);
    }
     ...
     * @author lihy
     */
    public static SqliteUtil getInstance(Context context, String dbName, int dbVersion, Map<String,String> tableSqls) {
        SqliteUtil dataBaseOpenHelper = dbMaps.get(dbName);
        if (dataBaseOpenHelper == null) {
            dataBaseOpenHelper = new SqliteUtil(context, dbName, dbVersion, tableSqls);
        }
    ...
    public void onCreate(SQLiteDatabase db) {
        for (Map.Entry<String, String> m : createTableList.entrySet()) {
            String tableName = m.getKey();
            String createTableSql = m.getValue();
            // check if table exist
            String checkSql ="SELECT count(*) AS cnt FROM sqlite_master WHERE type='table' AND name='"+tableName+"';";
    ...
    public void execSQL(String sql, Object[] bindArgs) {
        SqliteUtil dataBaseOpenHelper = dbMaps.get(nowDbName);
